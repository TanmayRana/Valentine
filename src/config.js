...
export const config = {
  ...
  unlockCode: "29", // Change this to your special code
  ...
  envelopes: [
    {
      ...
      content:
        "I miss you too! Remember, distance means nothing when someone means everything. You're always in my heart. 💕",
      image: "/images/envelope_miss_me.png", // Beautiful romantic illustration
      link: "https://open.spotify.com/playlist/4lasKEzdaNVjfzitekE9Dm", // Optional: external link (e.g., Spotify playlist)
    },
    {
      id: 2,
      ...
      type: "message",
      content:
        "Hey beautiful, I know things are tough right now, but remember: you are stronger than you think, braver than you believe, and loved more than you know. I'm always here for you. ❤️",
      image: "/images/envelope_sad.png",
      link: "https://open.spotify.com/playlist/37i9dQZF1DXdFesNN9TzXT",
    },
    {
      id: 3,
      ...
      type: "message",
      content:
        "Why don't scientists trust atoms? Because they make up everything! 😂 Just like how you make up my entire world. Love you!",
      image: "/images/envelope_laugh.png",
      link: "https://open.spotify.com/playlist/3bQy66sMaRDIUIsS7UQnuO",
    },
    {
      id: 4,
      ...
      type: "link",
      content:
        "Here's a playlist I made for you. Close your eyes and let the music carry you to dreamland. Sweet dreams, my love. 🌙",
      image: "/images/envelope_sleep.png",
      link: "https://youtu.be/e90alqXR9dM?si=4cm4Rz5WqN_7q2jW", // Replace with your playlist
    },
    {
      id: 5,
      ...
      type: "message",
      content:
        "You are capable of amazing things! Don't let anyone (including yourself) tell you otherwise. I believe in you more than you'll ever know. Now go crush it! 💪✨",
      image: "/images/envelope_motivation.png",
      link: "https://youtube.com/playlist?list=PL0h4Aliuif76OGHuEDdoiaMBueDblqcn2&si=9ENvhh_oU_UGGwF2",
    },
    {
      id: 6,
      ...
      type: "message",
      content:
        "Just a reminder that you're the best thing that's ever happened to me. I love you on Tuesdays, and every other day too. 💖",
      image: "/images/envelope_random.png",
      link: "https://youtube.com/playlist?list=PLtgWTUdMPxCNhfFOxCw_8_K9aCU4vRVHo&si=3iri4kszDHiyFbta",
    },
  ],
